...
function onSearchNode(){
    document.getElementById("taxSearch");
    var text = inp.value;
    findNode(text)
...
//autocomplete stuff
function autocomplete(inpName,filter) {
    
    inp = document.getElementById(inpName);
    ...
    inp.addEventListener("input", function(e) {
        ...
        //use filter instead of array
        //print("K",filter.queryTaxons(undefined,val))
        //var keys = filter.getTopNKeys(4,val)
        //print(filter.getTaxons(key))
        
        var nodes = filter.queryXTaxons(4,undefined,val)
        ...
        nodes.forEach(
            (node) =>{
                ...
                //b.innerHTML = "<strong>" + node.n.substr(0, val.length) + "</strong>";
                b.innerHTML += node.n;
                /*insert a input field that will hold the current array item's value:*/
                b.innerHTML += "<input type='hidden' value='" + node.n + "'>";
